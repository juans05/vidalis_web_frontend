    ...
    <div style={{
      ...
      {!showForm && (
        <div style={{
          ...
          position: 'relative',
          zIndex: 10,
          background: `linear-gradient(135deg, ${DESIGN_TOKENS.colors.secondary} 0%, #a78bfa 50%, #2563eb 100%)`,
        ...
        <div style={{
          ...
          <div style={{
            ...
            <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: DESIGN_TOKENS.spacing.lg }}>
              ...
              <button
                type="submit"
                disabled={loading || !formData.name || !formData.email || !formData.password || emailError !== ''}
                style={{
                  width: '100%',
            ...
            <p style={{
              ...
              onMouseEnter={(e) => {
                (e.currentTarget as HTMLAnchorElement).style.color = DESIGN_TOKENS.colors.secondary;
                (e.currentTarget as HTMLAnchorElement).style.textDecoration = 'underline';
              }}
              onMouseLeave={(e) => {
                (e.currentTarget as HTMLAnchorElement).style.color = DESIGN_TOKENS.colors.primary;
