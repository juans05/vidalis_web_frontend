      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            {PLATFORMS.map((platform) => (<button key={platform.id} onClick={() => togglePlatform(platform.id)} className={`p-6 rounded-lg transition-all ${selectedPlatforms.includes(platform.id)
        ...
        {/* Selected Summary */}
        {selectedPlatforms.length > 0 && (<div className="mb-8 bg-blue-500/10 border border-blue-500/50 rounded-lg p-4">
...
//# sourceMappingURL=ConnectSocialPage.js.map