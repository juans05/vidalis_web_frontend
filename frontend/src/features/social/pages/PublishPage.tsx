...
import { publishVideo, scheduleVideo, getVideoAnalytics, getActivePlatforms } from '../../../services/social';
...
export function PublishPage(): JSX.Element {
  ...
  useEffect(() => {
    const loadData = async () => {
      if (!videoId || !user?.artistId) return;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black">
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        {/* Success Alert */}
        {success && (
          <div className="mb-8 bg-green-500/10 border border-green-500/50 rounded-lg p-4 flex items-start gap-3">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <div className="flex-1 bg-gray-700 rounded-full h-2">
                      <div
                        ...
                        style={{ width: `${(video.viral_score || 0) * 10}%` }}
                      />
                    </div>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {video.platforms.map((platform: string) => (
                        <span
                          key={platform}
                          className={`px-2 py-1 rounded text-xs font-semibold ${PLATFORM_COLORS[platform] || 'bg-gray-700'}`}
                        >
                          {platform}
                        </span>
                      ))}
            ...
            <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-8">
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-2 gap-2">
                  {['REELS', 'STORIES', 'FEED', 'VIDEO'].map((type) => (
                    <button
                      key={type}
              ...
              <div className="mb-8">
                ...
                {activePlatforms.length === 0 ? (
                  <div className="bg-yellow-500/10 border border-yellow-500/50 rounded-lg p-4 text-yellow-200">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                    {activePlatforms.map((platform) => (
                      <button
                        ...
                        className={`p-3 rounded-lg border-2 transition-all font-semibold text-sm capitalize ${
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 disabled:from-gray-600 disabled:to-gray-600 disabled:cursor-not-allowed text-white font-bold py-3 px-6 rounded-lg transition-all flex items-center justify-center gap-2"
              >
                {publishing ? (
                  <>
                    <Loader className="w-5 h-5 animate-spin" />
