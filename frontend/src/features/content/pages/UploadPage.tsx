  ...
  return (
    <div className="min-h-screen bg-bg-primary p-8">
      <div className="max-w-2xl mx-auto">
        ...
        {error && (
          <div className="bg-red-500 bg-opacity-20 text-danger p-4 rounded-lg mb-6 flex items-center gap-2">
            <AlertCircle size={20} />
            {error}
          </div>
        )}
        ...
        <div className="bg-bg-card rounded-lg p-8 shadow-lg">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {platforms.map((platform) => (
                  <label
                    key={platform}
                    className="flex items-center gap-2 p-3 bg-bg-secondary rounded-lg cursor-pointer hover:bg-bg-tertiary transition"
                  >
                    <input
                      type="checkbox"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-primary hover:bg-purple-600 text-white font-medium py-3 rounded-lg transition disabled:opacity-50 flex items-center justify-center gap-2"
            >
              <Upload size={20} />
