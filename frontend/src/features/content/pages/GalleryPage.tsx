...
import { contentService, Video } from '../../../services/content';
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          ...
          <button
            ...
            className="px-6 py-2 bg-primary hover:bg-purple-600 text-white rounded-lg transition"
          >
            New Upload
          </button>
        </div>
              ...
              <>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {data.videos.map((video: Video) => (
                    <div
                      key={video.id}
                      className="bg-bg-card rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition cursor-pointer group"
                        ...
                        {video.platforms.length > 0 && (
                          <div className="flex gap-1 mb-4 flex-wrap">
                            {video.platforms.map((p) => (
                              <span
                                key={p}
                                className="text-xs bg-bg-secondary px-2 py-1 rounded capitalize"
                              >
                                {p}
                              </span>
                            ))}
