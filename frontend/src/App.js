    ...
    return (<QueryClientProvider client={queryClient}>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/content/upload" element={<ProtectedRoute>
                <UploadPage />
              </ProtectedRoute>}/>
          <Route path="/content/gallery" element={<ProtectedRoute>
                <GalleryPage />
              </ProtectedRoute>}/>
          <Route path="/content/:videoId" element={<ProtectedRoute>
                <VideoDetailPage />
              </ProtectedRoute>}/>
          <Route path="/analytics" element={<ProtectedRoute>
                <AnalyticsDashboard />
              </ProtectedRoute>}/>
          <Route path="/growth" element={<ProtectedRoute>
                <GrowthProPage />
              </ProtectedRoute>}/>
          <Route path="/social/connect" element={<ProtectedRoute>
                <ConnectSocialPage />
              </ProtectedRoute>}/>
          <Route path="/social/publish/:videoId" element={<ProtectedRoute>
                <PublishPage />
              </ProtectedRoute>}/>
        </Routes>
      </BrowserRouter>
